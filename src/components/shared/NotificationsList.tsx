...
export default function NotificationsList({ notifications }: { notifications: TFriendRequest[] }) {
    return (
        <div className="flex flex-col absolute top-full right-0 mt-1.5 bg-white z-1 w-100 max-h-100 min-h-20 h-fit border border-zinc-100 shadow-xs shadow-zinc-100 rounded-md overflow-y-auto">
